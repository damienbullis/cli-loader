...
export function makeLoadingBar(options?: loadingBarOptions) {
  const {
    gradient,
    loadingBarLength,
    animationSpeed,
...
/**
 * REFACTOR:  (maybe switch to jest for testing? remove vitest and vite seems unneeded?)
 *
 * Notes I would like to make to the code support the following:
 *
 * 1. Handle character animation in the loading bar
 * 2. Handle color animation in the loading bar
 * 3. Handle the loading bar animation speed
 * 4. Handle infinite loading bar animations
 * 5. handle progress loading bar animations
 * 6. Handle custom loading bar animations
 *
 * Spinner:
 * 1. Handle custom spinner characters
 * 2. Handle independent spinner colors from the loading bar
 * 3. Handle spinner animation speed???
 */
